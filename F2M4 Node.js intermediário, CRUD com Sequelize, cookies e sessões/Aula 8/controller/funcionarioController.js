...
module.exports = class funcionarioController{
  ...
  static async FuncionarioUpdate(req, res) {
    ...
    res.json({ message: 'Cadastro atualizado com sucesso! Foram atualizados os seguintes dados: ', dados: funcionario });
  }
  ...
  static async FuncionarioDelete(req, res) {
    ...
    res.json( { message: 'Funcionario excluíido com sucesso!'});
  }
}