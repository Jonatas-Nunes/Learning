...
const db = new sqlite3.Database('empresa-aula-3.sqlite', (err) => {
    if (err) {
...
// db.run("INSERT INTO funcionarios(matricula,id_setor,nome,nascimento,telefone) values(1234,1,'ANA','12-04-1978','01219219')");
// db.run("INSERT INTO funcionarios(matricula,id_setor,nome,nascimento,telefone) values(1235,3,'IVO','12-12-2000','07280921')");
// db.run("INSERT INTO funcionarios(matricula,id_setor,nome,nascimento,telefone) values(1236,2,'OTO','07-02-1987','01219219')");
// db.run("INSERT INTO funcionarios('matricula',id_setor,nome,nascimento,telefone) values(1237,1,'CARINA','09-09-1990','02932176')")

db.each("SELECT matricula, nome FROM funcionarios", (err,row) => {
    if (err) {
